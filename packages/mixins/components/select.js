export default {
  ...
  render(h) {
    ...
    if (this.icon) {
      options.push(h('um-icon', { props: { name: this.icon }, slot: 'prefix' }))
    }
    return h(
      'div',
      {
    ...
    //             )
    //           })}
    //         {this.icon ? <um-icon name={this.icon} slot="prefix" /> : ''}
    //       </el-select>
    //     </div>
    //     <div class="um-select-button">
    //       <um-button
    //         v-show={this.showRefresh}
    //         icon="refresh"
    //         class="um-select-botton-refresh"
