<template>
  <um-box ref="page" class="um-form-page" no-scrollbar :title="title" :icon="icon" :header="header" :footer="!noFooter" :fullscreen="fullscreen" :loading="!noLoading && loading">
    <!--标题-->
    ...
    <section class="um-form-page-body">
      <um-scrollbar :horizontal="false">
        <um-form
          class="um-form-page-main"
          ref="form"
          no-loading
          :model="model"
          :rules="rules"
    ...
    <!--底部-->
    <template v-slot:footer class="um-form-page-footer">
      <div class="um-form-page-footer-left">
        <slot name="footer-left" />
      </div>
      <div class="um-form-page-footer-right">
        <slot name="fotter">
